//
//  RunLoopUsingViewController.m
//  BaseApp
//
//  Created by chenlina on 2025/3/30.
//

#import "RunLoopUsingViewController.h"
// 任务block
...
@interface RunLoopUsingViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation RunLoopUsingViewController
...
static void callBack(CFRunLoopObserverRef observer, CFRunLoopActivity activity, void *info) {
    observeRunLoopActicities(observer, activity, info);
    if (activity != kCFRunLoopBeforeWaiting) {
        
        return;
    }
    
    RunLoopUsingViewController *vc = (__bridge RunLoopUsingViewController *)info;
